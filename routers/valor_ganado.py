...
# ---------------------- Motor de cálculo ----------------------
# (F0.5b: el motor puro -_acum_a_semana, _calcular, _agrupar, _matriz_area_disciplina,
#  _calc_costo_mo, _totales- y la capa de datos -_improductivas, _datos_base- viven
#  en routers/ev/ y se re-exportan arriba.)
